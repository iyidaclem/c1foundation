<div>
    ...
    <body>
        ...
        <div>
            <form action="{{route('home.blogs.update')}}" method="post" enctype="multipart/form-data">
                ...
                <input name="title" value="{{ $blog->title }}" type="text" style="width: 100%;" placeholder="Enter title">
                @error("title")
                <div class="alert alert-danger">
                    {{$message}}
                </div>
