                    ...
                    <div class="fugu--thumb-three">
                        <div class="fugu--hero-thumb fugu--hero-thumb3">
                            <a href="https://near.org/">
                                <img class="wow fadeInUpX" data-wow-delay="0.20s" src="/images/built-on-near.png" alt="">
                            </a>
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="fugu--video-thumb wow fadeInUpX" data-wow-delay="0.10s">
                        <iframe src="https://nft.c1foundations.com" frameborder="0" width="100%;" height="500px"></iframe>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="fugu--section-title">
                <div class="fugu--default-content">
                    ...
                    <p>Explore different services offered by C1foundations</p>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-4 col-md-6">
                    <div class="fugu--iconbox-wrap fugu--iconbox-wrap3 wow fadeInUpX" data-wow-delay="0s">
                        <div class="fugu--iconbox-thumb">
                            <img src="/images/ngo.png" style="border-radius: 100%" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="fugu--iconbox-wrap fugu--iconbox-wrap3 wow fadeInUpX" data-wow-delay="0s">
                        <div class="fugu--iconbox-thumb">
                            <img src="/images/builder.png" style="border-radius: 100%" alt="">
                        </div>
                        <div class="fugu--iconbox-data">
                            <h4>C1 BUILDERs</h4>
                            <p>
